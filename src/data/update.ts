...
export const filterUpdateEntities = (
  ...
  (
    ...
    if (a.attributes.title === "eDashboard Core") {
      return -3;
    }
    if (b.attributes.title === "eDashboard Core") {
      return 3;
    }
    if (a.attributes.title === "eDashboard Operating System") {
      return -2;
    }
    if (b.attributes.title === "eDashboard Operating System") {
      return 2;
    }
    if (a.attributes.title === "eDashboard Supervisor") {
      return -1;
    }
    if (b.attributes.title === "eDashboard Supervisor") {
      return 1;
    }
