...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the eDashboard service.", fields: {} },
    restart: { description: "Restart the eDashboard service.", fields: {} },
    check_config: {
      description:
        "Check the eDashboard configuration files for errors. Errors will be displayed in the eDashboard log.",
      fields: {},
    },
    update_entity: {
