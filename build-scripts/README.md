# Bundling eDashboard Frontend

The eDashboard build pipeline contains various steps to prepare a build.
...
Currently in eDashboard we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
